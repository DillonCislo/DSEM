...
namespace DSEMpp {
  ...
  class BFGSMat {
    ...
    public:
      ...
      ///
      DSEM_INLINE void reset( int n, int m );
      ...
      ///
      DSEM_INLINE void addCorrection( const RefConstVec &s, const RefConstVec &y );
      ...
      ///   res   #V by 1 vector
      ///
      DSEM_INLINE void applyHv( const Vector &v, const Scalar &a, Vector &res );
