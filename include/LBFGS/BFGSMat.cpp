...
DSEM_INLINE void DSEMpp::BFGSMat<Scalar>::reset( int n, int m ) {
...
///
template <typename Scalar>
DSEM_INLINE void DSEMpp::BFGSMat<Scalar>::addCorrection(
...
///
template <typename Scalar>
DSEM_INLINE void DSEMpp::BFGSMat<Scalar>::applyHv(
